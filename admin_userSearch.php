    ...
    <div class="flex flex-col mt-16 mb-4 w-full items-center justify-center">
        ...
        <form class="flex items-center mt-4" action="./admin_userSearch.php" method="POST">   
            ...
            <div class="relative w-full">
                ...
                <input type="text" name="search" class="pl-10 pr-2 h-10 w-full py-1 rounded-lg border border-gray-400 focus:border-gray-600 focus:outline-none focus:shadow-inner leading-none" placeholder="Search">            </div>
